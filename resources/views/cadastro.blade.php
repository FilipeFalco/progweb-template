                        ...
                        <div class="col s12 m6 offset-m3">
                            <div class="card blue darken-2 ">
                                <div class="card-content">
                                    <span class="card-title blue darken-2 white-text">Cadastro</span>
                                    <form>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input placeholder="Nome" id="cadastro" type="text" class="validate white-text">
                                                <label for="login" class="active">Nome</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input placeholder="Email" id="cadastro" type="text" class="validate white-text">
